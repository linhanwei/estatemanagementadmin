...
<div>
    <table class="table table-bordered text-center" style="table-layout: fixed">
        ...
        <tr>
            ...
            <th><i class="fa fa-flask"></i>品牌:</th>
            <th>${brandMap.get(item?.brandId)?.name}</th>
        </tr>
        <tr>
    ...
    <table class="table table-bordered" style="table-layout: fixed">
        ...
        <tr>
            <th>操作:</th>
            <th><button class="btn btn-info pull-right"
                        onclick="window.location.replace('/itemPublish/edit?id=${item?.id}')">编辑该商品</button></th>
        </tr>
        </thead>
    </table>
</div>
