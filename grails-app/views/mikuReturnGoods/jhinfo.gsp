...
<section class="content">
        ...
        <div class='col-xs-12'>
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="jhinfo" controller="mikuReturnGoods">用户寄货中</g:link></li>
    ...
    <div class="box">
        ...
        <div class="box-header">
            <g:form action="jhinfo" class="form-inline">
        ...
        <div class="box-footer clearfix">
            ...
            <div class="pagination pull-right">
                <g:paginate next="下一页" prev="上一页" params="${params}"
                            maxsteps="10" action="jhinfo" total="${total}"/>
            </div>
        </div><!-- /.box-footer-->
    </div><!-- /.box -->
</section><!-- /.content -->
