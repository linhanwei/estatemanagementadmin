        ...
        <div class='col-xs-12'>
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="index" controller="mikuReturnGoods">申请退货货物</g:link></li>
                ...
                <g:if test="${total > 0}">
                    <g:each status="i" in="${mikuReturnGoodsList}" var="trade">
                        <tr id="${trade.id}" class="info">
                            ...
                            %{--<th>--}%
                                %{--<g:if test="${trade.tradeStatus==4 as byte || trade.tradeStatus==6 as byte}">--}%
                                        %{--发货前的订单--}%
                                %{--</g:if>--}%
                                %{--<g:else>--}%
                                        %{--发货后的订单--}%
                            ...
                            <th>
                                ...
                                <g:elseif test="${trade?.ispassDate==1 as byte}">
                                    ...
                                    <g:else>
                                        <button type="button" class="btn btn-success btn-sm" onclick="returnGood(${trade.id})">审核</button>
                                        <button type="button" class="btn btn-warning btn-sm" onclick="noreturnGood(${trade.id})"
                                                data-toggle="modal"
...
<script type="text/javascript">
    function returnGood(id){
        $.ajax({
            url: '/mikuReturnGoods/returnGoodToSH',
            data: {'id': id},
            type: "POST",
            dataType: "json",
            success: function (data) {
                var str='/mikuReturnGoods/index';
