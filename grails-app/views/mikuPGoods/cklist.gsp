        ...
        <div class="box-header">
            <form action="" class="form-inline">
                ...
                <div class="col-md-4">
                    ...
                    %{--<button class="btn btn-success pull-right" onclick="window.location.replace('/trade/createOneExcel')"  target="_blank" ><i class="fa fa-download"></i>下载模板</button>--}%
                ...
                <g:if test="${total > 0}">
                    <g:each status="i" in="${tagList}" var="trade">
                            <tr id="${trade?.tradeId}" class="info">
                                ...
                                <td> ${trade?.memo}</td>
                                <td>
                                    %{--<button class="btn btn-warning" onclick="window.location.replace('/mikuPGoods/doSuccessOneTrade?id=${trade?.id}')">确定</button>--}%
                                    <button type="button" class="btn btn-danger btn-sm"
                                            onclick="window.location.replace('/mikuPGoods/cancelOneTradeToWc?id=${trade?.id}')">
                                        返回
                                    </button>
                                    <button type="button" class="btn btn-success btn-sm" id="data_btn">
                                        详情
                                    </button>
        ...
        <div class="box-footer clearfix">
            <div class="col-sm-4" style="margin: 20px 0;">
                <form action="" method="post">
                    <butoton class="btn btn-success" onclick="window.location.replace('/mikuPGoods/downloadExcelByTradeId?flag=3')">批量导出</butoton>
            ...
            <g:if test="${total > 0}">
                <div class="pagination pull-right">
                    <g:paginate next="下一页" prev="上一页" params="${params}"
                                maxsteps="10" action="cklist" total="${total}"/>
                </div>
            </g:if>
        </div><!-- /.box-footer-->
    </div><!-- /.box -->
