        ...
        <div class='col-xs-12'>
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li ><g:link action="zcSuccess"
                                               controller="mikuCrowdfundTrade">众筹成功未处理订单</g:link></li>
                    <li class="active"><g:link action="dfhuo" controller="mikuCrowdfundTrade">待发货</g:link></li>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <g:form action="dfhuo" class="form-inline" useToken="true">
                                            ...
                                            <td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <g:select optionKey="key" optionValue="value" name="max"
                                                              class="form-control" from="${PageMap}"
                                                              value="${params.max}"
                            ...
                            <div class="box-body table-responsive no-padding">
                                <g:form action="arrangeTradeCourier" params="${params}" id="shipBox">
                            ...
                            %{--导入功能--}%
                                <g:uploadForm action="inputPortExcelByTrade" enctype="multipart/form-data" style="display:none" controller="trade">
                            ...
                            %{--下载Excel模板--}%
                                <g:form action="downloadExcel" controller="trade" style="display: none;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <g:form useToken="true" action="sendOneTradeFromDo" controller="trade">
                ...
                <input name="type"  value="7" style="display: none;">
...
//        var query = $("#query").val();
        ...
        var str = '/mikuCrowdfundTrade/dfhuo?max=' + size + "&payType=" + payType + "&startTime=" + startTime + "&endTime=" + endTime + "&tradeCode=" + tradeCode;
