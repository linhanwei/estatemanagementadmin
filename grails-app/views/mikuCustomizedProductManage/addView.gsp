...
<head>
    ...
    #prodCostPrice_t,#prodRetailPrice_t{color: red;display: none;}
    </style>
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="addView">增加产品</g:link></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <g:form name="item_form" useToken="true" action="add">
            ...
            <div class="box-body no-padding form-horizontal list-group">
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <g:select optionKey="key" optionValue="value" name="prodType"
                                  class="form-control" from="${prodTypeMap}" value=""
                                  noSelection="['': '请选择']"/>
                    </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3" id="mul_add_list">
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <textarea rows="3" id="prodIngredient" name="prodIngredient" class="form-control" placeholder="产品成分"></textarea>
                    </div>
                    ...
                    <div class="col-xs-3">
                        ...
                        <textarea rows="3" name="" id="use_problem" class="form-control" placeholder="产品可以使用的问题" readonly></textarea>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        ...
                        <textarea rows="3" name="" id="use_efficacy" class="form-control" placeholder="产品功效" readonly></textarea>
                    ...
                    <div class="col-xs-3">
                        <input type="number" id="prodCostPrice" name="prodCostPrice" class="form-control"
                               placeholder="成本价" >
                        <span class="red_font" id="prodCostPrice_t">成本价不能为空</span>
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <input name="prodRetailPrice" id="prodRetailPrice" class="form-control" placeholder="建议零售价" type="number"/>
                        <span class="red_font" id="prodRetailPrice_t">成本价不能为空</span>
                    </div>
                    <label class="col-xs-2 control-label">产品效果：</label>
                    <div class="col-xs-3">
                        <textarea rows="3" id="prodResult" name="prodResult" class="form-control" placeholder="产品效果"></textarea>
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <textarea rows="3" id="prodPurpose" name="prodPurpose" class="form-control" placeholder="产品用途"></textarea>
                    </div>
                    <label class="col-xs-2 control-label">产品状态：</label>
                    <div class="col-xs-3">
                        <g:select optionKey="key" optionValue="value" name="prodShowStatus"
                                  class="form-control" from="${prodShowStatusMap}" value=""
                                  noSelection="['': '请选择']"/>
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3" id="_prodSkinApplys">
                        <g:each  in="${prodSkinApplysMap}" var="prodSkinApply">
                            <g:if test="${prodSkinIdList}">
                                <g:if test="${prodSkinIdList.contains(prodSkinApply.key)=="true"}">
                    ...
                    <div class="col-xs-3">
                        <g:select optionKey="key" optionValue="value" name="prodUseStandardCondition"
                                  class="form-control" from="${prodUseStandardConditionMap}" value=""
                                  noSelection="['': '请选择']"/>
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <textarea rows="3" id="prodNote" name="prodNote" class="form-control" placeholder="产品备注"></textarea>
                    </div>
                </div>
...
//    //checkbox模板---产品可以使用的问题
    ...
    $("#fbBtn").on('click',function(){
        var prodCostPrice=$('#prodCostPrice').val();
        var prodRetailPrice=$('#prodRetailPrice').val();
        if(prodCostPrice==''){
            $('#prodCostPrice_t').show();
        }else{
            $('#prodCostPrice_t').hide();
        }
        if(prodRetailPrice==''){
            $('#prodRetailPrice_t').show();
        }else{
            $('#prodRetailPrice_t').hide();
        }

        if(prodCostPrice=='' || prodRetailPrice==''){
            return false;
        }
        ...
        obj.prodCostPrice=$('#prodCostPrice').val();//产品成分
        ...
        console.log(obj.prodSkinApplys)
