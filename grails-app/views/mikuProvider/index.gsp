...
<head>
    ...
    #check_category span{color: red;display: none;}
        ...
        <form action="add" name="item_form" id="item_form">
            ...
            <div class="box-body no-padding form-horizontal list-group">
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <input type="tell" name="lphone" class="form-control" placeholder="手机">
                    </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <input type="text" name="address" class="form-control" placeholder="地区">
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <label class="col-xs-2 control-label">账期(天)：</label>
                    <div class="col-xs-3">
                        <input type="number" name="accounttime" class="form-control" placeholder="账期（天）">
                    </div>
                </div>

                <div class="list-group-item form-group">
                    <label class="col-xs-2 control-label">售后联系人：</label>
                    <div class="col-xs-3">
                        <input type="text" name="scontacts" class="form-control" placeholder="售后联系人">
                    </div>
                    <label class="col-xs-2 control-label">售后联系方式：</label>
                    <div class="col-xs-3">
                        <input type="text" name="scall" class="form-control" placeholder="售后联系方式">
                    </div>
                </div>

                <div class="list-group-item form-group">
                    <label class="col-xs-2 control-label">发货联系人：</label>
                    <div class="col-xs-3">
                        <input type="text" name="fcontacts" class="form-control" placeholder="发货联系人">
                    </div>
                    <label class="col-xs-2 control-label">发货联系方式：</label>
                    <div class="col-xs-3">
                        <input type="text" name="fcall" class="form-control" placeholder="发货联系方式">
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-8 form-group">
                        ...
                        <p id="category_txt" class="col-xs-10 form-group"></p>
                        %{--<input id="category_txt" type="text" value="${cateNameList}" class="form-control" disabled/>--}%
                        <input id="category_id" type="hidden" value="" name="clssfiyId"/>
                    </div>
