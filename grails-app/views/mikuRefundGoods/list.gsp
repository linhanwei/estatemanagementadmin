                    ...
                    <g:if test="${total > 0}">
                        <g:each status="i" in="${tagList}" var="trade">
                            <tr id="${trade?.tradeId}" class="info">
                                ...
                                <td> ${trade?.memo}</td>
                                <td>
                                    <button class="btn btn-warning btn-sm" onclick="window.location.replace('/mikuPGoods/doSuccessOneTrade?tradeId=${trade?.tradeId}')">出库</button>
        ...
        <div class="box-footer clearfix">
            <div class="col-sm-4" style="margin: 20px 0;">
                <form action="" method="post">
                    ...
                    <butoton class="btn btn-success" onclick="window.location.replace('/mikuPGoods/downloadExcelByTradeId?flag=1')">批量导出</butoton>
