...
<form id="alipaysubmit" name="alipaysubmit" action="https://mapi.alipay.com/gateway.do?_input_charset=utf-8" method="get">
    ...
    <input type="hidden" name="email" value="${sPara.get('email')}"/>
    <input type="hidden" name="account_name" value="${sPara.get('account_name')}"/>
    <input type="hidden" name="pay_date" value="${sPara.get('pay_date')}"/>
    <input type="hidden" name="batch_fee" value="${sPara.get('batch_fee')}"/>
    ...
    %{--<input type="hidden" name="buyer_account_name" value="${sPara.get('email')}"/>--}%
