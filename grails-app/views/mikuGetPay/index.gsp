        ...
        <div class='col-xs-12'>
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active"><g:link action="index" controller="mikuGetPay">未审核提现</g:link></li>
                    <li><g:link action="allInfo" controller="mikuGetPay">全部提现</g:link></li>
                </ul>
