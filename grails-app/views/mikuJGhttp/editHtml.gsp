...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <g:form name="push_form" useToken="true" action="editSub">
                <input type="hidden" name="id" value="${msg_id}">
                <input type="hidden" name="msg_id" value="${msgInfo.jpush_msg_id}">
                <div class="box-header">
                </div><!-- /.box-header -->
                <div class="box-body no-padding form-horizontal list-group"  id="tragetTable">
                    ...
                    <div class="list-group-item form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" name="msgTitle" value="${msgInfo.msg_title}" class="form-control"
                                   placeholder="输入推送标题">
                        </div>
                    </div>
                    ...
                    <div class="list-group-item form-group">
                        ...
                        <div class="col-xs-8">
                            <textarea name="msgContent" class="form-control" rows="3" placeholder="输入推送内容">${msgInfo.msg_content}</textarea>
                        </div>
                    </div>
                            ...
                            <div class="input-group">
                                <g:if test="${redirectTypeMap != null}">
                                    <g:each in="${redirectTypeMap}" var="tag" status="i">
                                        ...
                                        <g:if test="${redirectType == tag.key}">
                    ...
                    <div class="list-group-item form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" name="target" value="${target}" class="form-control" id="ImpcontentFlag"
