        ...
        <div class='col-xs-12'>
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li  class="active"><g:link action="getSharePay" controller="mikuPayMoney">平台分润提现支出</g:link></li>
                                    ...
                                    <table style="width:100%">
                                        <tr>
                                            <div class="form-group">
                                                <span style="font-size:20px;color:red">共${alipayNum+WxNum}笔提现,共计${SumFeel/100f}元</span>&nbsp;&nbsp;
                                            </div>
                                            <div class="form-group">
                                                <span style="font-size:20px;color:red">${alipayNum}笔支付宝提现,共计${alipayFeel/100f}元</span>&nbsp;&nbsp;
                                            </div>
                                            <div class="form-group">
                                                <span style="font-size:20px;color:red">${WxNum}笔微信提现,共计${WxFeel/100f}元</span>&nbsp;&nbsp;
                                            </div>
                                        </tr>
                                    </table>
                                </g:form>
                                ...
                                <g:form action="changeSumGetPayStatusMethod" params="${params}"  id="shipBox">
                                    <table style="table-layout:fixed" class="table table-hover table-striped table-bordered text-center">
                                        <tr>
                                            ...
                                            <th><i class="fa fa-clock-o"></i>提现用户</th>
                                            <th><i class="fa fa-clock-o"></i>提现电话</th>
                                            <th ><i class="fa fa-map-marker"></i>提现金额</th>
                                                    ...
                                                    <th>
                                                        <g:if test="${getPay.payType == 1 as byte}">
                                                            <div style="padding-top: 10px">
                                                                <span style="color: #a47e3c">支付宝提现</span>
                                                            </div>
                                                        </g:if>
                                                        <g:if test="${getPay.payType == 2 as byte}">
                                                            <div style="padding-top: 10px">
                                                                <span style="color: #a47e3c">微信支付</span>
                                                            </div>
                                                        </g:if>
                                                    </th>
                                                    <th >${getPay.info}</th>
