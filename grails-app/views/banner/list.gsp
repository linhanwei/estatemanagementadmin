        ...
        <div class='col-xs-12'>
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    <li><g:link action="index">Banner列表</g:link></li>
                            ...
                            <td>
                                <g:if test="${goods?.status == 0 as byte}">
                                    <button type="button" class="btn btn-primary btn-sm"
                                            onclick="window.location.replace('/banner/changeOneActicestatus?flag=1&id=${goods.id}')">
                                        有效
                                    </button>
                                </g:if>
                                <g:if test="${goods?.status == 1 as byte}">
                                    <button type="button" class="btn btn-danger btn-sm"
                                            onclick="window.location.replace('/banner/changeOneActicestatus?flag=0&id=${goods.id}')">
                                        无效
                                    </button>
                                </g:if>
                                ...
                                <button type="button" class="btn btn-success btn-info" onclick="window.location.replace('/banner/edit?id=${goods.bannerId}')">
                                    修改
                                </button>
                            </td>
                        </tr>
