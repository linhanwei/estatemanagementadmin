                    ...
                    <div class="row">
                        ...
                        <div class="form-group hide" >
                            ...
                            <div class="col-xs-2" style="  padding-right: 5px;">
                                <input type="text" name="levelid" class="form-control" id="levelid" value="${oneLevel.id}"
                                      >
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="line-height: 34px; ">
                            ...
                            <div class="col-xs-2" style="  padding-right: 5px;">
                                <input type="text" name="profitpercent" class="form-control" value="${oneLevel.defaultShareScale}" id="profitpercentflg"
                                       placeholder="分润比例" style="display: inline-block">
                            </div>
                            <p >%</p>
                            <p id="mytipcontent"></p>
                            <p id="mytipflg" class="hide">1</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2" style="  padding-right: 5px;">
                                <input type="text" name="profitInfo" class="form-control"  value="${oneLevel.memo}"
                                       placeholder="等级说明" id="profitInfo">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $("#profitpercentflg").on('change',function(){
        ...
        $.ajax({
            url:'<g:createLink controller="profitManager" action="getUpAllpercent" />',
            data:{'id':$("#levelid").val().trim()},
            type: "POST",
            dataType: "json",
