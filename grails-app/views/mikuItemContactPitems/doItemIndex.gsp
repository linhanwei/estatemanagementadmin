        ...
        <g:form name="item_form" useToken="true" action="publish">
            ...
            <div class="box-body no-padding form-horizontal list-group">
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="title" class="form-control"
                               placeholder="标题"  value="${mikuPiteminfo.title}">
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="keyWord" class="form-control"
                               placeholder="搜索关键字"  value="${mikuPiteminfo.keyword}">
                    </div>
                </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <input type="text" name="code" class="form-control" placeholder="商品编码" value="${mikuPiteminfo.code}">
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <div class="input-group" style="width: 235px">
                            <span class="input-group-addon"><i class="fa fa-rmb"></i></span>
                            <input type="tel" name="postFee" class="form-control" id="postFee"  value="${mikuPiteminfo.postFee/100f}">
                            <span class="input-group-addon">元</span>
                        </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <div class="input-group" style="width: 235px">
                            ...
                            %{--value="${(purchase?.price ?: 0) / 10000f}">--}%
                                   value="${mikuPiteminfo.jhprice/100f}">
                            <span class="input-group-addon">元</span>
                        </div>
                    ...
                    <div class="col-xs-3">
                        <div class="input-group" style="width: 235px">
                            <span class="input-group-addon"><i class="fa fa-rmb"></i></span>
                            <input type="tel" name="referencePrice" class="form-control" value="${mikuPiteminfo.xsprice/100f}" >
                            <span class="input-group-addon">元</span>
                        </div>
                ...
                <div class="list-group-item form-group">
                    ...
                    <div class="col-xs-3">
                        <input name="num" class="form-control" placeholder="库存"  value="${mikuPiteminfo.num}" />
                        %{--<input name="num" class="form-control" style="width: 100px"/>--}%
