        ...
        <div class='col-xs-12'>
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="dfhuo" controller="mikuCustomizedOrder">待发货</g:link></li>
                    <li><g:link action="shipped" controller="mikuCustomizedOrder">已发货/待收货</g:link></li>
                    <li><g:link action="zcFail" controller="mikuCustomizedOrder">失败订单</g:link></li>
                                ...
                                <g:form action="shipTradeChecked" params="${params}" id="shipBox">
                                    <table style="table-layout:fixed" class="table table-hover table-striped table-bordered text-center">
                                        <tr>
                                            ...
                                            <th><i class="fa fa-money"></i>收货地址</th>
                                        ...
                                        <g:if test="${total > 0}">
                                            <g:each status="i" in="${tradeList}" var="trade">
                                                <tr id="${trade.tradeId}" class="info">
                                                    ...
                                                    <g:if test="${trade?.status == '7'}">
                                                        <th style="color: limegreen"><i class="fa fa-check"></i>交易完成</th>
                                                    </g:if>
                                                    <g:if test="${trade?.status == '8'}">
                                                        <th style="color: #000000"><i class="fa fa-times"></i>
                                                            <g:if test="${trade?.crowdfundRefundStatus == 0 as byte}">
                                                                正常状态
                                                            </g:if>
                                                            <g:if test="${trade?.crowdfundRefundStatus == 1 as byte}">
                                                                退款中
                                                            </g:if>
                                                            <g:elseif  test="${trade?.crowdfundRefundStatus == 2 as byte}">
                                                                退款完成
                                                            </g:elseif>
                                                        </th>
                                                    </g:if>
                                                    <g:if test="${trade?.status == '9'}">
                                                        <th style="color: #000000"><i class="fa fa-times"></i>已关闭</th>
                                                    </g:if>
                                                    <g:if test="${trade?.status == '20'}">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">发货信息</h4>
            </div>
            <g:form useToken="true" action="sendOneTradeFromDo" controller="trade">
                <input id="readySendTradeId" name="tradeId" style="display: none;">
                <input name="type"  value="12" style="display: none;">
...
<script>
    ...
    $("#max").on("change",function(){
        ...
        var str='/mikuCrowdfundTrade/index?max='+size+"&payType="+payType+"&startTime="+startTime+"&endTime="+endTime+"&totalFeeOp="+totalFeeOp+"&targetTotalFee="+targetTotalFee+"&tradeCode="+tradeCode+"&query="+query;
