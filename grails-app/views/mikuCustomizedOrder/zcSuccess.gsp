        ...
        <div class='col-xs-12'>
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li  class="active"><g:link action="zcSuccess" controller="mikuCustomizedOrder">未处理订单</g:link></li>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary">
                            <div class="box-header">
                                <g:form action="zcSuccess" class="form-inline" useToken="true">
                            ...
                            %{--测试打印--}%
                                <g:form action="outPortExcelByTrade"  style="display: none;" controller="tradeNoShip">
                                    <input type="text" id="TradeExcelids" name="TradeExcelids" />
                                    <input type="submit"  id="outPortExcelByTradeFormsubmit">
                                </g:form>

                            %{--全部打印--}%
                                <g:form action="outPortAllExcelByTrade"  style="display: none;" controller="tradeNoShip">
                            ...
                            <div class="box-footer clearfix">
                                ...
                                <div class="pagination pull-right">
                                    <g:paginate next="下一页" prev="上一页" params="${params}"
                                                maxsteps="10" action="zcSuccess" total="${viewTotal}"/>
                                </div>
...
//        var query=$("#query").val();
        ...
        var str='/mikuCrowdfundTrade/zcSuccess?max='+size+"&payType="+payType+"&startTime="+startTime+"&endTime="+endTime+"&tradeCode="+tradeCode;
