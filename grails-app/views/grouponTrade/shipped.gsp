        ...
        <div class="row">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="shipped">已派单</g:link></li>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <g:form action="shipped" class="text-left">
                                    <div class="col-sm-3">

                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-clock-o"></i>时间:
                                            </div><input value="${new Date().format('yyyy-MM-dd') + '前'}"
                                                         name="acceptTime"
                                                         readonly/>
                                        </div><!-- /.input group -->
                                ...
                                <div class="col-sm-4">
                                    <div class="search-form">
                                        <g:form action="shipped" class="text-right" useToken="true">
                                            <div class="input-group">
                                ...
                                <g:if test="${total > 0}">
                                    ...
                                    <div class="pagination pull-right">
                                        ...
                                        <g:form action="exportExcel">
                                            <input name="communityId" value="${communityId}" style="display: none"/>
                                            <input name="query" style="display: none" value="${params.query}"/>
                                            <input name="status" value="5" style="display: none"/>
