        ...
        <div class="row">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="close">已关闭</g:link></li>
                </ul>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary">
                            <div class="box-header">
                                <g:form action="close" class="text-left">
                                    <div class="col-sm-3">
                                ...
                                <div class="col-sm-4">
                                    <div class="search-form">
                                        <g:form action="close" class="text-right" useToken="true">
                                            <div class="input-group">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table style="table-layout:fixed" class="table table-hover table-striped table-bordered text-center">
                                    <tr class="info">
                                        ...
                                        <th style="width: 150px"><i class="fa fa-times"></i>下单时间</th>
                                ...
                                <g:if test="${total > 0}">
                                    ...
                                    <div class="pagination pull-right">
                                        <g:paginate next="下一页" prev="上一页" params="${params}"
                                                    maxsteps="10" action="close" total="${total}"/>
                                        <g:form action="exportExcel">
                                            ...
                                            <input name="status" value="9" style="display: none"/>
...
<script>
    ...
    function lookTradeDetail(id) {
        ...
        jQuery.ajax({
            type: 'POST',
            data: {'tradeId': id},
            url: '/grouponTrade/lookTradeDetail',
