        ...
        <div class="row">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    <li><g:link action="nopay">未付款</g:link></li>
                    <li class="active"><g:link action="index">未派单</g:link></li>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <g:form action="index" class="text-left">
                                    <div class="col-sm-3">

                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-clock-o"></i>时间:
                                            </div><input value="${acceptTime}"
                                                         name="acceptTime"
                                ...
                                <table style="table-layout:fixed" class="table table-hover table-striped table-bordered text-center">
                                    ...
                                    <g:if test="${total > 0}">
                                        <g:each status="i" in="${tradeList}" var="trade">
                                            <tr class="info">
                                                <th>${tradeMap.get(trade.id)?.tradeId}</th>
                                ...
                                <g:if test="${total > 0}">
                                    ...
                                    <div class="pagination pull-right">
                                        ...
                                        <g:form action="exportExcel">
                                            <input value="${params.acceptTime}" style="display: none"
                                                   name="acceptTime" class="input-sm form_datetime" readonly/>
                                    ...
                                    <div>
                                        <g:form action="sendAll" before="sendAllConfirm()">
                                            <input value="${params.acceptTime}" style="display: none"
                                                   name="acceptTime" class="input-sm form_datetime" readonly/>
                                            <input name="communityId" value="${params.communityId}"
                                                   style="display: none"/>
                                            <button onclick="return confirm('您确定一键发货???')" type="submit"
                                                    class="btn btn-warning pull-left">批量发货<i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <g:form action="sendTrade" class="text-left" useToken="true">

                    <input id="sendId" name="tradeId" class="input-sm" style="display: none"/>

                    <div class="input-group-btn">
                        <button type="submit"
                                class="btn btn-primary pull-right"><i class="fa fa-truck"></i>发货!</button>
                    </div>
