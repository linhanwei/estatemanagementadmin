        ...
        <div class="row">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><g:link action="history">历史订单</g:link></li>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <g:form action="history" class="text-left">
                                    <div class="col-sm-3">
                                ...
                                <div class="col-sm-4">
                                    <div class="search-form">
                                        <g:form action="history" class="text-right" useToken="true">
                                            <div class="input-group">
                                ...
                                <g:if test="${total > 0}">
                                    ...
                                    <div class="pagination pull-right">
                                        <g:paginate next="下一页" prev="上一页" params="${params}"
                                                    maxsteps="10" action="history" total="${total}"/>
                                        <g:form action="exportExcel">
                                            ...
                                            <input name="status" value="7" style="display: none"/>
