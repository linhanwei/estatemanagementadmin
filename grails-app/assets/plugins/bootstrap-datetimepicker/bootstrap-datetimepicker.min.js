!function (c) {
    ...
    var e = function (i, h) {
        ...
        this.picker = c(j).appendTo(this.isInline ? this.element : this.container).on({click: c.proxy(this.click, this), mousedown: c.proxy(this.mousedown, this)});
    ...
    e.prototype = {constructor: e, _events: [], _attachEvents: function () {
        ...
        var G = new Date(this.viewDate), s = G.getUTCFullYear(), H = G.getUTCMonth(), l = G.getUTCDate(), B = G.getUTCHours(), w = G.getUTCMinutes(), x = this.startDate !== -Infinity ? this.startDate.getUTCFullYear() : -Infinity, C = this.startDate !== -Infinity ? this.startDate.getUTCMonth() + 1 : -Infinity, n = this.endDate !== Infinity ? this.endDate.getUTCFullYear() : Infinity, y = this.endDate !== Infinity ? this.endDate.getUTCMonth() + 1 : Infinity, p = (new f(this.date.getUTCFullYear(), this.date.getUTCMonth(), this.date.getUTCDate())).valueOf(), F = new Date();
