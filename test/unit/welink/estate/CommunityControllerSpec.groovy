...
class CommunityControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        !model.communityInstanceList
        model.communityInstanceCount == 0
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        community = new Community(params)
    ...
    void "Test that the show action returns the correct model"() {
        ...
        model.communityInstance == community
    }
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        response.reset()
        populateValidParams(params)
        community = new Community(params).save(flush: true)
        controller.update(community)
