...
public class UpYunTest {
    ...
    // 运行前先设置好以下三个参数
    private static final String BUCKET_NAME = "bonamana";
    private static final String USER_NAME = "beneo";
    private static final String USER_PWD = "welink168";
     ...
     * 本地待上传的测试文件
     */
    private static String SAMPLE_TXT_FILE = null;
    ...
    static {
        ...
        try {
            URL resource = Thread.currentThread().getContextClassLoader().getResource("com/upyun/test.txt");
            SAMPLE_TXT_FILE = resource.toURI().getPath();
    ...
    @Test
    public void testUpYun() throws Exception {
        // 初始化空间
