...
/**
 * 如果字段值为null, 字符串类型字段为空, Collection型字段为空, Map型字段为空, 数组型字段为空将不包含在toString中.
 * 此外, 如果字段对象没有重载实现自定义的toString方法, 则通过{@link ToStringBuilder}反射输出
 *
 * @author saarixx
 */
public class NoNullFieldStringStyle extends ToStringStyle {
    ...
    private static final long serialVersionUID = -7846619114700551769L;
